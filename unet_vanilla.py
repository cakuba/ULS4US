#
#  vanilla UNet for Lesion segmentation in Ultrasound Images
#
...
if __name__ == "__main__":
    ...
    print("A total number of %d training and %d valid images fed into the network training..." % (nums_of_train_images,nums_of_valid_images))
    ...
    model = unet.UNet_vanilla(img_width=img_size[0], img_height=img_size[1])
    ...
    if resumed_training:
        last_weights_file = './weights/04_vanilla_unet_augmentation_model-weights-epoch-500_all_mixed_FINAL.hdf5'
