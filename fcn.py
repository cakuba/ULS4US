#
#  FCN+ for Lesion segmentation in Ultrasound Images
#
...
from models import fcn as models
...
if __name__ == "__main__":
    ...
    # fcn16模型初始化
    base_model = models.vgg16(dropout=0.2)
    ...
    del weight_list
    fcn32 = models.fcn32(base_model)
    model = models.fcn16(base_model, fcn32)
